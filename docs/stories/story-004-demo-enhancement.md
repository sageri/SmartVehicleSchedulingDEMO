...
- [ ] **Story 4.1 完了:** 選択状態詳細 Drawer が正常動作、全データ正確表示
- [ ] **Story 4.2 完了:** 方案対比 Tab が正常動作、基線 vs 最適化の差分明確
- [ ] **Story 4.3 完了:** ルート矢印が全ルートに表示、方向正確
- [ ] **統合テスト:** 3 機能が同時動作、相互干渉なし
- [ ] **既存機能検証:** Story 003 の全機能が正常動作（リグレッションなし）
- [ ] **ドキュメント更新:** README.md, story-004-completion-report.md 作成
- [ ] **コードレビュー:** TypeScript エラーなし、Lint 警告なし
