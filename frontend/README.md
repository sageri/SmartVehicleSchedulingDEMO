...
2. 拠点1件、車両3台、配送先20件が自動生成される
3. 地図上に拠点（青）と配送先（赤/オレンジ/緑）が表示される
...
1. **単一拠点のみ:** Demo では 1 拠点のみサポート（Backend 制限）
2. **同期 API:** 最適化実行中は他の操作不可（30秒上限）
...
4. **複数拠点対応:** Backend 拡張後に対応
5. **レスポンシブ対応:** モバイル表示最適化

---

**作成者:** 開発チーム
**最終更新:** 2025-11-03
**Status:** ✅ Story 003 実装完了
